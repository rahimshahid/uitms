...
public class Evaluate {
	...
	public static String evalMicClassifier(RandomForest rf, ArrayList<Feature> testData) throws Exception {

		//BufferedReader reader = new BufferedReader(new FileReader(testData));

		// Read and store the names of the features
		//String headerLine = reader.readLine();
		String[] featureNames = {"AVG_DX2_LEFT","AVG_DX2_RIGHT","FIRST_LEFT_DETECTION","FIRST_RIGHT_DETECTION","MAX_DX2_LEFT","MAX_DX2_RIGHT","MAX_AMP_LEFT","MAX_AMP_RIGHT","AVG_AMP_LEFT","AVG_AMP_RIGHT","DX2_DELTA","AMP_DELTA","DETECTION_DELTA"};
		...
		for(int i=0; i<featureNames.length; i++)
			featureValues[i] = String.valueOf(testData.get(i).val);
